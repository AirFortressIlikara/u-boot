...
#ifdef CONFIG_TARGET_LS2K500_MODI_HCT
//#if 0
	// 傲翔时序要另外适配。不能影响其他板卡，最好将 VGA 时序写在 dts 中，以后优化
	{       38226,  800,    840,    880,    1056,   600,    604,    607,    628,    },      /*"800x600_60.00" */
#else
